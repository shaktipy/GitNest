...
// Import your architecture diagram image (adjust path if needed)
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f6f8f7] dark:bg-[#07090d] text-zinc-900 dark:text-white transition-colors">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-16">
        ...
        {/* Current Project Structure – Tree Card */}
        <div className="mb-8">
          <div className="group relative overflow-hidden rounded-[34px] border border-white/60 dark:border-white/5 bg-gradient-to-br from-white via-[#f7fffc] to-[#f4fffb] dark:from-[#11161d] dark:to-[#0c1017] p-8 shadow-xl">
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
...
└── frontend/
    ...
    └── src/
        ...
        {/* Architecture Diagram Card – Image only */}
        <div className="mb-20">
          <div className="group relative overflow-hidden rounded-[34px] border border-white/60 dark:border-white/5 bg-gradient-to-br from-white via-[#f7fffc] to-[#f4fffb] dark:from-[#11161d] dark:to-[#0c1017] p-8 shadow-xl">
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
              ...
              <div className="w-full flex justify-center">
                <img
                  ...
                  className="w-full max-w-3xl h-auto rounded-xl shadow-lg border border-[#e6ece9] dark:border-white/10"
                />
              </div>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-[34px] border border-white/60 dark:border-white/5 bg-gradient-to-br from-white via-[#f7fffc] to-[#f4fffb] dark:from-[#11161d] dark:to-[#0c1017] p-8 shadow-xl">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white dark:bg-[#0e1219] rounded-2xl p-5 border border-[#e6ece9] dark:border-white/10 shadow-sm">
                  <div className="w-12 h-12 rounded-xl bg-[#00dc82]/10 flex items-center justify-center mb-4"><Code2 className="w-6 h-6 text-[#00dc82]" /></div>
                  <h3 className="text-xl font-bold mb-2">CLIENT</h3>
                  <p className="text-zinc-600 dark:text-zinc-400">React Frontend<br />Vite + TailwindCSS</p>
                </div>
                <div className="bg-white dark:bg-[#0e1219] rounded-2xl p-5 border border-[#e6ece9] dark:border-white/10 shadow-sm">
                  <div className="w-12 h-12 rounded-xl bg-[#00dc82]/10 flex items-center justify-center mb-4"><Server className="w-6 h-6 text-[#00dc82]" /></div>
                  <h3 className="text-xl font-bold mb-2">REST API</h3>
                  <p className="text-zinc-600 dark:text-zinc-400">Node.js<br />Express.js</p>
                </div>
                <div className="bg-white dark:bg-[#0e1219] rounded-2xl p-5 border border-[#e6ece9] dark:border-white/10 shadow-sm">
                  <div className="w-12 h-12 rounded-xl bg-[#00dc82]/10 flex items-center justify-center mb-4"><Database className="w-6 h-6 text-[#00dc82]" /></div>
                  <h3 className="text-xl font-bold mb-2">DATABASE</h3>
                  <p className="text-zinc-600 dark:text-zinc-400">MongoDB<br />Mongoose</p>
                </div>
                <div className="bg-white dark:bg-[#0e1219] rounded-2xl p-5 border border-[#e6ece9] dark:border-white/10 shadow-sm">
                  <div className="w-12 h-12 rounded-xl bg-[#00dc82]/10 flex items-center justify-center mb-4"><Zap className="w-6 h-6 text-[#00dc82]" /></div>
                  <h3 className="text-xl font-bold mb-2">CACHE & REAL‑TIME</h3>
                  <p className="text-zinc-600 dark:text-zinc-400">Redis · Socket.io</p>
                </div>
                <div className="bg-white dark:bg-[#0e1219] rounded-2xl p-5 border border-[#e6ece9] dark:border-white/10 shadow-sm">
                  <div className="w-12 h-12 rounded-xl bg-[#00dc82]/10 flex items-center justify-center mb-4"><Lock className="w-6 h-6 text-[#00dc82]" /></div>
                  <h3 className="text-xl font-bold mb-2">AUTH & SECURITY</h3>
                  <p className="text-zinc-600 dark:text-zinc-400">JWT · bcrypt · Helmet</p>
                </div>
                <div className="bg-white dark:bg-[#0e1219] rounded-2xl p-5 border border-[#e6ece9] dark:border-white/10 shadow-sm">
                  <div className="w-12 h-12 rounded-xl bg-[#00dc82]/10 flex items-center justify-center mb-4"><Cloud className="w-6 h-6 text-[#00dc82]" /></div>
                  <h3 className="text-xl font-bold mb-2">STORAGE</h3>
                  <p className="text-zinc-600 dark:text-zinc-400">Cloudinary · Supabase</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="relative overflow-hidden border-t border-[#dce7e3] bg-[#f8fbfa] dark:bg-[#080b11] py-20 mt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-16">
            <div>
              ...
              <p className="text-[15px] text-[#7c8aa5] leading-7">© 2026 GitNest. Built for open-source collaboration.</p>
            </div>
            <div>
              <h4 className="text-[28px] font-black tracking-[-0.04em] text-[#071138] dark:text-white mb-8">Platform</h4>
              <div className="space-y-5">
                {["Repositories", "Pull Requests", "AI Workflows", "Discussions"].map((item) => (
                  <a key={item} href="#" className="group flex items-center gap-3 text-[17px] text-[#475569] hover:text-[#00b86b] transition">
            ...
            <div>
              <h4 className="text-[28px] font-black tracking-[-0.04em] text-[#071138] dark:text-white mb-8">Developers</h4>
              <div className="space-y-5">
            ...
            <div>
              <h4 className="text-[28px] font-black tracking-[-0.04em] text-[#071138] dark:text-white mb-8">Tech Stack</h4>
              <div className="flex flex-wrap gap-2">
                {["React", "Tailwind", "Node.js", "MongoDB", "Express", "Socket.io", "JWT", "AI"].map((tech) => (
                  <div key={tech} className="px-5 py-3 rounded-2xl border border-[#e6ece9] bg-white shadow-sm hover:shadow-md hover:-translate-y-1 transition-all text-[15px] font-medium text-[#334155] flex items-center gap-3">
            ...
            <div>
              <h4 className="text-[28px] font-black tracking-[-0.04em] text-[#071138] dark:text-white mb-8">Legal</h4>
              <div className="space-y-5">
                <Link to="/terms" className="group flex items-center gap-3 text-[17px] text-[#475569] hover:text-[#00b86b] transition">
                  <div className="w-2 h-2 rounded-full bg-[#00c97b] group-hover:scale-150 transition-transform" />
                  Terms & Conditions
                </Link>
              </div>
